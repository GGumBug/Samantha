...
2026-08-24 갱신. 다른 PC에서 이어가기 위한 인수인계. 대상 저장소는 **Double Down** — 현재 작업 브랜치는 **`feature/floor-stack`**(`c6d8552`까지).
...
1. **양쪽 저장소 pull** — Double Down은 **`feature/floor-stack`** 을 checkout 한다(`master` 로 시작하면 이 브랜치의 커밋이 안 보인다), Samantha `master`
